...
import Map_weather from "../assets/img/weather.png";
        ...
        <div className="white_bg">
            <div className="breadcrumb_b">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Davlat hokimiyati</Breadcrumb.Item>
                </Breadcrumb>
            </div>
            <span className="inner_title">Davlat hokimiyati</span>
            <button type="button" className="btn print_btn"><img src={Icon_print} /></button>
            <div className="simple_portal_text">
                <ul className="authority_list">
                    <li><a href="https://president.uz/oz" target="_blank">Prezident</a></li>
                    <li>
                        <a href="#">Oliy majlis</a>
                        <ul>
                            <li><a href="#" target="_blank">Qonunchilik palatasi</a></li>
                            <li><a href="#" target="_blank">Senat</a></li>
                        </ul>
                    </li>
                    <li><Link to="/portal/page1" target="_blank">Hukumat</Link></li>
                    <li>
                        <a href="#">Sud hokimiyati</a>
                        <ul>
                            <li><a href="http://www.konstsud.uz/oz" target="_blank">Konstitutsiyaviy sud</a></li>
                            <li><a href="https://sud.uz/" target="_blank">Oliy sud</a></li>
                        </ul>
                    </li>
                    <li><a href="https://www.saylov.uz/oz" target="_blank">Markaziy saylov komissiyasi</a></li>
                    <li><a href="https://www.prokuratura.uz/index.php?lang=oz#/" target="_blank">Prokuratura</a></li>
                </ul>
            </div>
