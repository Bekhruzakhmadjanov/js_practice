...
import Population_img from "../assets/img/aholi_img.png";
        ...
        <div className="white_bg">
            <div className="breadcrumb_b">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Aholi</Breadcrumb.Item>
                </Breadcrumb>
            </div>
            <span className="inner_title">Aholi</span>
