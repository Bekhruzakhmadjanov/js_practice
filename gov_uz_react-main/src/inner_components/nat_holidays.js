...
import Nat_holiday from "../assets/img/national_holidays.png";
        ...
        <div className="white_bg">
            <div className="breadcrumb_b">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Milliy bayramlar</Breadcrumb.Item>
                </Breadcrumb>
            </div>
            <span className="inner_title">Milliy bayramlar</span>
            <button type="button" className="btn print_btn"><img src={Icon_print} /></button>
            <div className="simple_portal_text">
                <span className="center_img">
                    <img src={Nat_holiday} />
                </span>
            </div>
